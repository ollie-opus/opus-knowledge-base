...
| <span class="mb-label mb-label-green">Requirement fulfilled</span> | The time passed since the last submission is within the requirement's defined submit interval and before the lead time begins. | An Annual Service was last submitted 6 months ago. It is currently fulfilled. |

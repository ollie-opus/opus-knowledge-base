...
| <span class="mb-label mb-label-green">Requirement fulfilled</span> | The time passed since the last submission is within the requirement's defined submit interval and before the lead time begins. | An Annual Service that was last submitted 6 months ago is considered fulfilled. |
| <span class="mb-label mb-label-orange">Requirement due</span> | The time passed since the last submission is within the requirement's defined submit interval but after the lead time begins. | An Annual Service (with a 14 day lead time) that was last submitted 11 months and 20 days ago is considered due. It is not yet overdue, but it is within its lead time. |
| <span class="mb-label mb-label-rose">Requirement overdue</span> | The time passed since the last submission is beyond the requirement's defined submit interval. | An Annual Service that was last submitted 13 months ago is considered overdue. |

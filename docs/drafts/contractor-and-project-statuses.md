...
=== "Table"
    ...
    | <span data-uuid="4b829f8a-5152-4d31-b183-6aa35f36017c" style="display:none"></span>![](../assets/media/occ-captures/admin/sites/uuid/incomplete-light-mode.png#only-light){ style="height: 30px" loading=lazy } ![](../assets/media/occ-captures/admin/sites/uuid/incomplete-dark-mode.png#only-dark){ style="height: 30px" loading=lazy } | At least one requirement for the Contractor has not yet been fulfilled. |
